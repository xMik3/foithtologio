...
public class AddStudent extends JPanel {
    ...
    public AddStudent(SecretaryInterface secretaryInterface) {
        ...
        JPanel middleLeftPanel = new JPanel(new GridLayout(4,1,0,20));

        middleLeftPanel.add(nameLabel);
        middleLeftPanel.add(surnameLabel);
        middleLeftPanel.add(enrollmentYearLabel);
        ...
        JPanel middleRightPanel = new JPanel(new GridLayout(4,1,0,20));

        middleRightPanel.add(name);
        middleRightPanel.add(surname);
        middleRightPanel.add(enrollmentYear);
        ...
        mainPanel.setBorder(BorderFactory.createEmptyBorder(0,20,60,60));
        ...
        confirm.addActionListener(l -> {
                   ...
                   int requestEnrollmentYear = Integer.parseInt(enrollmentYear.getSelectedItem().toString());
